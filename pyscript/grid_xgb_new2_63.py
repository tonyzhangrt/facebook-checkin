...
TRAIN_TEST_HASH_FILE = '../input/train_test_hash_63_159.csv'

timestamp =  datetime.datetime.now().strftime('%Y%m%d%H%M%S')

VALID_LOG_FILE = '../valid/valid_log_xgb_new2_63_{0:s}.csv'.format(timestamp)
VALID_OUTPUT_FILE = '../valid/valid_score_xgb_new2_63_{0:s}.csv'.format(timestamp)
TEST_OUTPUT_FILE = '../train/test_score_xgb_new2_63_{0:s}.csv'.format(timestamp)
SUBMISSION_FILE = '../output/submission_xgb_new2_63_{0:s}.csv'.format(timestamp)
