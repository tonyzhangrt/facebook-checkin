...
VALID_LOG_FILE = '../valid/valid_log_xgb_aug_nn_63xys_{0:s}.csv'.format(timestamp)
VALID_OUTPUT_FILE = '../valid/valid_score_xgb_aug_nn_63xys_{0:s}.csv'.format(timestamp)
TEST_OUTPUT_FILE = '../train/test_score_xgb_aug_nn_63xys_{0:s}.csv'.format(timestamp)
SUBMISSION_FILE = '../output/submission_xgb_aug_nn_63xys_{0:s}.csv'.format(timestamp)
...
def run_grid_xgb():
    ...
    for ix, [x_min, x_max] in enumerate(fetch_grid_1d_shift(range_x)):
