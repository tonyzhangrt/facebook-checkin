...
VALID_LOG_FILE = '../valid/valid_log_63xys_{0:s}.csv'.format(timestamp)
VALID_OUTPUT_FILE = '../valid/valid_score_63xys_{0:s}.csv'.format(timestamp)
TEST_OUTPUT_FILE = '../train/test_score_63xys_{0:s}.csv'.format(timestamp)
SUBMISSION_FILE = '../output/submission_63xys_{0:s}.csv'.format(timestamp)
